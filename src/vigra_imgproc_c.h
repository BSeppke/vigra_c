...
LIBEXPORT int vigra_affinewarpimage_c( const PixelType *arr_in, const float *arr_out, double *affineMatrix, const int width, const int height, const int resample_method);
