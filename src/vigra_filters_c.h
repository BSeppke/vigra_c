...
LIBEXPORT int vigra_gaussiangradient_c(const PixelType *arr_in, const PixelType *arr_out, const PixelType *arr3, const int width, const int height, const float sigma);
...
LIBEXPORT int vigra_gaussiansmoothing_c(const PixelType *arr , const PixelType *arr_out, const int width, const int height, const float sigma);
...
LIBEXPORT int vigra_hessianmatrixofgaussian_c(const PixelType *arr_in, const PixelType *arr_xx, const PixelType *arr_xy, const PixelType *arr_yy, const int width, const int height, const float scale);
LIBEXPORT int vigra_structuretensor_c(const PixelType *arr_in, const PixelType *arr_xx, const PixelType *arr_xy, const PixelType *arr_yy, const int width, const int height, const float inner_scale, const float outer_scale);
LIBEXPORT int vigra_boundarytensor_c(const PixelType *arr_in, const PixelType *arr_xx, const PixelType *arr_xy, const PixelType *arr_yy, const int width, const int height, const float scale);
LIBEXPORT int vigra_boundarytensor1_c(const PixelType *arr_in, const PixelType *arr_xx, const PixelType *arr_xy, const PixelType *arr_yy, const int width, const int height, const float scale);
LIBEXPORT int vigra_gradientenergytensor_c(const PixelType *arr_in, const double *arr_derivKernel, const double *arr_smoothKernel, const PixelType *arr_xx, const PixelType *arr_xy, const PixelType *arr_yy, const int width, const int height, const int derivKernel_size, const int smoothKernel_size);
